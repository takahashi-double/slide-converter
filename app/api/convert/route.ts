...
export async function POST(req: NextRequest) {
  try {
    ...
    const prompt = `この${isPdf ? 'PDF' : '画像'}を解析しスライド構成を作成してください。スタイル:${style}。JSON形式のみで返答:{"title":"タイトル","slides":[{"type":"title","title":"タイトル","subtitle":"サブ","body":"本文","bullets":["項目1"]}]}ルール:全テキスト抽出。3〜8枚。1枚目はtype:title。日本語で出力。`;
